...
function fibonacci(n){
   ...
   for (var i=0; i<=n; i++){
        var fibNum = x;  //initalize the sum at 0. This will be the added last two indexes in the sequence
        x = y;           //set first of pair to be added next round
        y+=fibNum;       //set second of pair to be added next round
    } 
    return fibNum;
}
